...
#' @return Character. Reveal js slide formated for rmarkdown.
#' @export
...
html_slide <- function(title = "",
  ...
  properties <- dplyr::case_when(
    image != "" ~ paste0(' {data-transition="',transdata,'" data-background-transition="',transback,'" data-background-color="',colorback,'" data-background="',image,'"}'),
    video != "" ~ paste0(' {data-transition="',transdata,'" data-background-transition="',transback,'" data-background-color="',colorback,'" data-background-video="',video,'"}'),
    TRUE ~ paste0(' {data-transition="',transdata,'" data-background-transition="',transback,'" data-background-color="',colorback,'"}')
  )
